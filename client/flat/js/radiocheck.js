...
+(function(global, $) {
  const Radiocheck = function(element, options) {
  ...
  function Plugin(option) {
    return this.each(function() {
      ...
      const mobile = /mobile|tablet|phone|ip(ad|od)|android|silk|webos/i.test(global.navigator.userAgent);
